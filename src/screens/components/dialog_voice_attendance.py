...
# Import correctly matching your project components
...
def voice_attendance_dialog(selected_subject_id):
    ...
    if st.button("Analyze Audio", use_container_width=True, type="primary"):
        # 1. Prevent crash if button is pressed without recording audio
        ...
        with st.spinner("Processing Audio data..."):
            ...
            # Capture current timestamp directly in IST timezone
